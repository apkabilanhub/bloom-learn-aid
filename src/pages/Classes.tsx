...
export default function Classes() {
  ...
  const handleCreate = () => {
    ...
    setClasses([...classes, {
      ...
      instructor: "You", students: 0, color: "bg-accent",
    }]);
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm">Manage your enrolled classes</p>
        </div>
            ...
            <DialogContent>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input placeholder="Enter class code" value={joinCode} onChange={(e) => setJoinCode(e.target.value)} />
                </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {classes.map((cls) => (
          <Card key={cls.id} className="glass-card hover:shadow-md transition-shadow cursor-pointer">
